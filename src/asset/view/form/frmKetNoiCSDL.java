...
public class frmKetNoiCSDL extends Shell {
	...
	public frmKetNoiCSDL(Display display) {
		...
		label_1.setImage(SWTResourceManager.getImage(frmKetNoiCSDL.class, "/asset/view/form/imgKetNoiCSDL_64p.png"));
		...
		txtServer.setBounds(131, 104, 241, 24);
				...
				btnKetNoi.setImage(SWTResourceManager.getImage(frmKetNoiCSDL.class, "/asset/view/form/moveright_16x16.png"));
		...
		btnLuu.setImage(SWTResourceManager.getImage(frmKetNoiCSDL.class, "/asset/view/form/save_16x16.png"));
		...
		btnHuyBo.setImage(SWTResourceManager.getImage(frmKetNoiCSDL.class, "/asset/view/form/cancel_16x16.png"));
